        ...
        <div className="w-full max-w-5xl flex flex-col gap-5 md:gap-12">
          ...
          <div className="max-w-2xl flex flex-col gap-4 sm:gap-6">
            ...
            <p className="font-sans text-sm sm:text-base text-neutral-400 leading-relaxed">
              Our Innovation Laboratory is where experimental concepts, internal frameworks, and active engineering demonstrations are developed publicly.
            </p>
                ...
                >
                  <div className="flex flex-col gap-3">
                    <div className="flex items-center justify-between text-[10px] font-mono text-neutral-500">
                      ...
                      <span className="text-viyaan-cyan font-semibold">{proj.statusText}</span>
                    </div>
                  ...
                  <div className="mt-6 pt-4 border-t border-neutral-900/60">
                    <Link
                      href={`/contact?subject=${encodeURIComponent(proj.title)}`}
